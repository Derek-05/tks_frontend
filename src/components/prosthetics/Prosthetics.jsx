...
const Prosthetics = () => {
  return (
    ...
    <div class="prosthetics-text">
        ...
        <p>
            This type of prosthesis does not have active movement. They improve the function of
            the pointed side, they provide support for the execution of certain activities that
            require it.</p>
...
<div class="prosthetics">
    ...
    <div class="prosthetics-text">
        ...
        <p> Activity-specific protheses are designed for an activity
            in which the residual limb without a prosthesis,or passive,
            mechanical or myoelectric prothesis,could damage the prothesis
            or simply cannot or is not suitable for the specific activity.
            For example, in the execution of sports or other hobbies that
            require a very specific subjection.
        </p>
    </div>
